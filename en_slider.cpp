...
en_slider::en_slider(pong *pong, QGraphicsScene *s, QTimer *t, int indent)  //Конструктор
{
    m_pong = pong;
    m_indent = indent;
    m_timer = t;
...
void en_slider::resiv(bool a, bool b)   //Слот для получения сигнала от клавиатуры
{
    moveDown = a;
    moveUp   = b;
}

void en_slider::reset() //Установление на стартовую позицию
{
